...
for subj=1:size(subjects,1)
    ...
    % non-relevant events
   %dataset_path = EEGPreprocessing(1:13, [eeg_data_folder subjects{subj} '\' subjects{subj} '.bdf'], ref_electrodes);
    ...
    CalcDeltasFromFreqMaps(relevant_events, dataset_path, electrodes_list, calc_energies_MFCC_like, [matlab_data_folder subjects{subj} '\' 'cond_duration.mat']); 
